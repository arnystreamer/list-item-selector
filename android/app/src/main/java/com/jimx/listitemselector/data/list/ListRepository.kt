...
interface ListRepository {
    ...
    suspend fun addListItem(categoryId: Int, listItem: ItemData)
    suspend fun editListItem(categoryId: Int, listItem: ItemData)
    suspend fun deleteListItem(categoryId: Int, listItem: ItemData)
